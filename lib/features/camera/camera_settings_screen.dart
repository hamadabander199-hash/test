  ...
  Widget _buildAboutTab(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const Text(
          "Camzone يصوّر الفيديو والصور ويشفرها محليًا على جهازك مباشرة "
              "بعد التصوير وقبل رفعها، بحيث محدش يقدر يوصل للمحتوى الأصلي "
              "غير الطرف اللي معاه المفتاح الخاص.",
          style: TextStyle(
